  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-brand-secondary px-6">
      <div className="w-full max-w-sm rounded-2xl border border-foreground/5 bg-background p-8 shadow-sm">
        ...
        <h1 className="mt-6 text-2xl font-semibold text-foreground">Masuk</h1>
        <p className="mt-1 text-sm text-foreground/60">Lanjutkan untuk mengelola undangan Anda.</p>
        <div className="mt-6">
          <AuthForm mode="login" />
        </div>
      </div>
